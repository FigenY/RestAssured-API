...
public class PojoTest {
    ...
    public void test1() {
        ...
        Map<String, Object> user = response.body().as(Map.class);

        UserQuery pojoUser = response.body().as(UserQuery.class); // deserialization with pojo classes
    ...
    public void test3() {
        ...
        String json = gson.toJson(userQuery); //serialization
